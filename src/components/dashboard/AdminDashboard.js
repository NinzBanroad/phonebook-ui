    ...
    <>
      {users === null ? (
        ...
        <>
          ...
          <div className='flex min-h-full flex-1 flex-col justify-center px-10 py-3 lg:px-8'>
                ...
                {users.length === 0 ? (
                  <>
                    <tr>
                      <td></td>
                      <td></td>
                      <td className='pt-5'>NO AVAILABLE USERS </td>
                      <td></td>
                      <td></td>
                    </tr>
                  </>
                        ...
                        <td className='px-6 py-4'>
                          {user.Status === 'approved' ? (
                            ...
                            <button
                              type='button'
                              onClick={() =>
                                approveUser(user.UserID, 'approved')
                              }
